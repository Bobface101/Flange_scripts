...
# Collect ALL X and Y coordinates to find the true bounding box
        ...
        #hatch center
        scr_lines.append("-HATCH")
        scr_lines.append(fmt(midpoint(pE,pJ,pD)))
        scr_lines.append("")  
        ...
        #attributes
        scr_lines.append(f"""{NPS:g}", CL{Series:g}, RF, BLND, [material], B16.5""")
        scr_lines.append(f"""{NPS:g}", CL{Series:g}, RF, BLND, [материал], B16.5""")
