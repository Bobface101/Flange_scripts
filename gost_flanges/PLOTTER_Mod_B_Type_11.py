...
# Collect ALL X and Y coordinates to find the true bounding box
        ...
        #attributes
        scr_lines.append(f"{flange[0:5]}, {flange[6:]} Type11 Mod.B - GOST 33259-2015")
        scr_lines.append(f"{flange[0:5]}, {flange[6:]} Тип11 Исп.B - ГОСТ 33259-2015")
        scr_lines.append(f"1:{dimscale}")    #scale
        scr_lines.append(f"{flange[2:5]}-{flange[8:]}-11-B-09G2S GOST 33259-2015")
    ...
    scr_lines.append("90")
    scr_lines.append("Mod. B Type 11")
    scr_lines.append("\n\n")
