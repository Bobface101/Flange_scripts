## For Mod E., Type 11 GOST flanges
import math
import csv
import os
...
# Collect ALL X and Y coordinates to find the true bounding box
        ...
        temp = (conjugate(C)[0], conjugate(C)[1])
        ...
        #attributes
        scr_lines.append(f"{flange[0:5]}, {flange[6:]} Type11 Mod.E - GOST 33259-2015")
        scr_lines.append(f"{flange[0:5]}, {flange[6:]} Тип11 Исп.E - ГОСТ 33259-2015")
        scr_lines.append(f"1:{dimscale}")    #scale
        scr_lines.append(f"{flange[2:5]}-{flange[8:]}-11-E-09G2S GOST 33259-2015")
    ...
    scr_lines.append("90")
    scr_lines.append("Mod. E Type 11")
    scr_lines.append("\n\n")
