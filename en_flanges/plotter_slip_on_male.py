...
# Collect ALL X and Y coordinates to find the true bounding box
        ...
        scr_lines.append("0")
        scr_lines.append(f"""Slip-On Male""")
        scr_lines.append("\n\n")
        ...
        scr_lines.append(fmt(midpoint(pC,pD)))
        ...
        #attributes
        scr_lines.append(f"""EN 1092-1/01/E/DN{DN}/{PN}/[material]""")
        scr_lines.append(f"""EN 1092-1/01/E/DN{DN}/{PN}/[материал]""")
